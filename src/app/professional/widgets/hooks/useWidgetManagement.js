...
} from "../../../fitness/widgets/utils/widgetTransformers";
import { normalizeAttributes } from "../../../fitness/widgets/utils/apiNormalizers";
...
export const useWidgetManagement = (isAuthenticated, accessToken) => {
  ...
  useEffect(() => {
    const fetchWidgets = async () => {
      ...
      try {
        ...
        // Get dashboards, find the user's OWN professional dashboard (not shared ones)
        ...
        const currentDashboardId = professionalDashboard.id;
        ...
        console.log("[Professional Widgets] fetchDashboardData response:", dashboardData);
        ...
        try {
          ...
          console.log(
            "[Professional Widgets] getDashboardAttributes:",
            attrs,
            "→ normalized:",
            list
          );
          ...
          console.error(
            "[Professional Widgets] getDashboardAttributes error:",
            attrErr
          );
          setAttributes([]);
        }
      } catch (err) {
        console.error("[Professional Widgets] Error loading widgets:", err);
  ...
  const refreshWidgets = async () => {
    ...
    try {
      ...
      console.error("[Professional Widgets] Error refreshing widgets:", err);

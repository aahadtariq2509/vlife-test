    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Configure your work dashboard settings and productivity preferences.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-600">
          Work settings page is under development. Here you will be able to:
        </p>
        <ul className="mt-4 space-y-2 text-gray-600">
          <li>• Set up work schedules and time tracking</li>
          <li>• Configure project management tools</li>
          <li>• Manage team collaboration settings</li>
          <li>• Set up productivity metrics</li>
          <li>• Configure work-life balance reminders</li>
        </ul>
      </div>
      ...
      <Card className="mt-4 p-4 md:p-8 bg-white border-[0.5px] border-[#0000001A] !rounded-[14.01px] shadow-[0px_14px_54px_0px_#00000008] w-full hover:shadow-[0px_14px_54px_0px_#00000008] duration-200">
        <Link
          href="/work/widgets"
          className={pathname === '/work/widgets' ? 'text-[#9747FF]' : 'text-[#4D4D4D] hover:text-[#7847FF]'}
        >
          <Card
            variant="filled"
            hover
